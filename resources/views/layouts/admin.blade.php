...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light" style="background-color:white;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/" class="nav-link" style="color:FireBrick; font-weight:900;">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-white-secondary ">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><strong>SuperAdmin</strong></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('hotels.index')}}" class="nav-link">
                  <i class="fas fa-hotel"></i><span class="hide-menu">  
                  Hotels
                </span></a>
              </li>
              <li class="nav-item">
                <a href="{{route('chambres.index')}}" class="nav-link">
                  <i class="fas fa-bed"></i><span class="hide-menu">
                  Rooms
                </span></a>
              </li>
              <li class="nav-item">
                <a href="{{route('typechambres.index')}}" class="nav-link">
                  <i class="fas fa-bed"></i><span class="hide-menu">
                  Room Types
                </span></a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('produits.index')}}" class="nav-link">
                  <i class="fas fa-cart-arrow-down"></i><span class="hide-menu">
                  Product
                </span></a>
              </li> 
              <li class="nav-item">
                <a href="{{route('rdvs.index')}}" class="nav-link">
                  <i class="fas fa-bed"></i><span class="hide-menu">
                  Reservation
                </span></a>
              </li>
          ...
          <li class="nav-item">
            <a href="../full-calender" class="nav-link">
