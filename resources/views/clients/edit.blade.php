                    ...
                    <form class="form-horizontal">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <textarea  name="adresse" class="form-control" rows="2" value="{{$client->adresse}}"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="tel" name="tel" class="form-control" value="{{$client->tel}}">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="number" name="age" class="form-control" value="{{$client->age}}">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <select  name="sexe" class="form-control" aria-invalid="false" value="{{$client->sexe}}">
                          ...
                          <div class="col-sm-9">
                          <select class="form-control" name="ville" aria-invalid="false" value="{{$client->ville}}">
                          <option value="">--Select--</option>
