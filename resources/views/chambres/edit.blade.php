            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    @enderror
                     ...
                     <img src="{{ Storage::url($chambre->image) }}" height="200" width="200" alt="" />
                     </div>
                    </div>
                    </div>
                            ...
                            @endforeach
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <select class="form-control" name="etage" aria-invalid="false" value="{{$chambre->etage}}">
                                    ...
                                    <label class="col-sm-3 text-right control-label col-form-label" for="fname"><strong>Base Price : </strong></label> 
                                            ...
                                            <input class="input-group-text" name="prix" type="number" value="{{$chambre->prix}}">
                                            <select class="input-group-text" name="devise" value="{{$chambre->devise}}">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="number" name="zone_residentielle" value="{{$chambre->zone_residentielle}}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <select class="form-control" name="etat" aria-invalid="false" value="{{$chambre->etat}}">
                                        <option value="">--Select--</option>
